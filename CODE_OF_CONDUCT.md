...
NexusAlign is committed to building an open, respectful, and inclusive research community around foundation model alignment.
...
- Spamming issues or pull requests with links to projects unrelated to this library
...
This Code of Conduct applies within all community spaces, including GitHub repositories, discussions, issues, pull requests, and any official communication channels.

It also applies when an individual is officially representing this project in public spaces, such as using an official project email address, posting via an official social media account, or acting as a project representative at an online or offline event.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers at yuanjk0921@outlook.com.

If the incident involves a specific maintainer, you may report it to other members of the NexusAlign Team via private channels. All complaints will be reviewed and investigated promptly and fairly.
